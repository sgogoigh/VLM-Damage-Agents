...
welfare check -> STEP 4 usability/authenticity. Cached by content hash; in mock
mode a neutral, deterministic finding is returned (no API call).
"""
...
from app.core.data_io import image_id_from_path, resolve_image_path
...
def analyze_image(
    ...
    # Namespace the cache by the ACTUAL client model + mock/live so Gemini and
    # Claude (and mock vs live) analyses never collide.
    cache_ns = (
